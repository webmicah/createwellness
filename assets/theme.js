  ...
  function initEventListeners() {
    ...
    if($('#accountModal').length > 0) {
      $(document).on('click','a[href*="/account/login"], a[href*="/account/register"],[data-href*="/account/login"], [data-href*="/account/register"]', function(evt) {
        ...
        //nws
        //if ($(this).attr('href') === '/account/register' || $(this).attr('data-href') === '/account/register') {$("#signin").removeClass('active show'); $("#register").addClass('active show'); alert('open');}else{ $("#signin").addClass('active show'); $("#register").removeClass('active show'); }
